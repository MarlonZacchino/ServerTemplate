...
stehen in [`CADDY_DEPLOYMENT.md`](CADDY_DEPLOYMENT.md). Caddy und Backend erhalten dabei automatisch
...
[`NOTIFICATIONS.md`](NOTIFICATIONS.md) und [`CALENDAR_PHASE6.md`](../history/CALENDAR_PHASE6.md).
