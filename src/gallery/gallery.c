        ...
        const char *notice_code)
{
    ...
    str_cat_cstr(
            page,
            "<!doctype html><html lang=\"de\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><meta name=\"robots\" content=\"noindex,nofollow\"><title>Galerie verwalten - Styling 4 Dogs</title><link rel=\"stylesheet\" href=\"/style.css\"><script src=\"/admin-gallery.js\" defer></script></head><body><header class=\"site-header\"><div class=\"container nav-wrap\"><a class=\"brand\" href=\"/\"><span class=\"brand-mark brand-mark-logo\"><img src=\"/logo.jpg\" alt=\"\"></span><span>Styling 4 Dogs</span></a><nav class=\"site-nav\" aria-label=\"Admin-Navigation\"><a href=\"/admin\">Übersicht</a><a href=\"/\">Website öffnen</a><a href=\"/admin/bookings\">Buchungsanfragen</a><a href=\"/admin/gallery\" aria-current=\"page\">Fotos</a><a href=\"/admin/appointments\">Termine</a><a href=\"/admin/notifications\">E-Mail</a><a href=\"/admin/calendar\">Einstellungen</a></nav></div></header><main class=\"page admin-page admin-gallery-page\"><section class=\"card admin-card admin-calendar-section\"><p class=\"eyebrow\">Admin</p><h1>Galerie verwalten</h1><p>Lade Bilder für Kundinnen und Kunden hoch und pflege die öffentliche Galerie.</p>");
