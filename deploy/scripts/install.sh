...
install_file 0644 root root "$PROJECT_ROOT/docs/operations/DEPLOYMENT.md" "$APP_PATH/share/DEPLOYMENT.md"
install_file 0644 root root "$PROJECT_ROOT/docs/operations/CADDY_DEPLOYMENT.md" "$APP_PATH/share/CADDY_DEPLOYMENT.md"
install_file 0644 root root "$PROJECT_ROOT/docs/operations/RATE_LIMITING.md" "$APP_PATH/share/RATE_LIMITING.md"
install_file 0644 root root "$PROJECT_ROOT/docs/history/CALENDAR_PHASE5.md" "$APP_PATH/share/CALENDAR_PHASE5.md"
install_file 0644 root root "$PROJECT_ROOT/docs/history/CALENDAR_PHASE6.md" "$APP_PATH/share/CALENDAR_PHASE6.md"
install_file 0644 root root "$PROJECT_ROOT/docs/history/GALLERY_PHASE8.md" "$APP_PATH/share/GALLERY_PHASE8.md"
install_file 0644 root root "$PROJECT_ROOT/docs/history/CUSTOMER_PORTAL_PHASE9.md" "$APP_PATH/share/CUSTOMER_PORTAL_PHASE9.md"
