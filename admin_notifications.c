...
string *admin_notifications_build_page(const char *csrf_token, const char *notice_code)
{
    ...
    str_cat_cstr(page, "<!doctype html><html lang=\"de\"><head><meta charset=\"utf-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\"><meta name=\"robots\" content=\"noindex,nofollow\"><title>E-Mail und Nachrichten - Styling 4 Dogs</title><link rel=\"stylesheet\" href=\"/style.css\"></head><body><header class=\"site-header\"><div class=\"container nav-wrap\"><a class=\"brand\" href=\"/\"><span class=\"brand-mark brand-mark-logo\"><img src=\"/logo.jpg\" alt=\"\"></span><span>Styling 4 Dogs</span></a><nav class=\"site-nav\" aria-label=\"Admin-Navigation\"><a href=\"/\">Website öffnen</a><a href=\"/admin/bookings\">Buchungsanfragen</a><a href=\"/admin/appointments\">Termine</a><a href=\"/admin/calendar\">Einstellungen</a><a href=\"/admin/gallery\">Fotos</a><a href=\"/admin/notifications\" aria-current=\"page\">E-Mail</a></nav></div></header><main class=\"page admin-page admin-notifications-page\"><section class=\"card admin-card\"><p class=\"eyebrow\">Admin</p><h1>E-Mail und Nachrichten</h1><p>Verbinde das Salon-Postfach, teste den Versand und passe automatische Nachrichten an.</p>");
